      ...
      <div className="hero-right">
        <div className="thank-you-cta-container">
          <div className="cta-card-wrapper">
            <a href="YOUR_YOUTUBE_LINK_HERE" target="_blank" rel="noopener noreferrer" className="cta-card youtube-card">
              ...
              <div className="cta-info">
                <h3>Vashishth (IDS)</h3>
                <p>Subscribe for SEO tutorials & tips</p>
              </div>
          ...
          <div className="cta-card-wrapper">
            <a href="YOUR_WHATSAPP_LINK_HERE" target="_blank" rel="noopener noreferrer" className="cta-card whatsapp-card">
              <div className="cta-icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="cta-info">
                <h3>VIP Community</h3>
                <p>Get exclusive SEO resources & links</p>
              </div>
