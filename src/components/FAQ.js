...
export default function FAQ() {
  ...
  const faqs = [
    ...
    { q: "How do I join the session on April 11th?", a: "After registering, you'll receive a Google Meet link via WhatsApp and email before the event. Click the link at 11:00 AM on April 11th from any device — phone, laptop, or tablet." },
